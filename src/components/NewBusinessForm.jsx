...
// Vraie création d'un vrai compte Business — utilisée à 2 vrais endroits : depuis une vraie
// revendication approuvée (claim fourni, vrai pré-remplissage + vraie liaison automatique de
// la fiche à la fin), ou depuis "Comptes Business" en création manuelle directe (claim absent,
// vrai formulaire vide, pas de vraie liaison puisqu'il n'y a pas de vraie fiche revendiquée).
export function NewBusinessForm({ claim = null, onCreated }) {
  ...
  return (
    <div style={{ marginTop: "10px", padding: "12px", background: "#0D1B2A", borderRadius: "8px", display: "flex", flexDirection: "column", gap: "8px", maxWidth: "380px" }}>
      ...
      >
        {saving ? "Création..." : claim ? "Créer le compte et lier la fiche" : "Créer le compte"}
      </button>
    </div>
  );
}
